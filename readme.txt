...
= 0.6.03 =
* Register legacy page-restore protection before the duplicate-class compatibility guard.

= 0.6.02 =
* Prevent the legacy child-theme page restore from overwriting published pricing updates.

= 0.6.01 =
* Set each video to $30 and Amazon Storefront posting to an additional $20 across the ordering page and checkout.

= 0.6.00 =
* Add official REii logo mark, icons, and social sharing card for reii.techbyleon.com, paired with official Tech By Leon 'by' branding.

= 0.5.99 =
* Add new custom Tech By Leon 'by' logo, crisp favicons, and dedicated social sharing card for techbyleon.com.
...
= 0.5.94 =
* Add stripe account check diagnostic endpoint.

= 0.5.93 =
* Enable customer-facing promotion codes and coupons on direct Stripe Checkout sessions and record discounted totals upon order creation.
